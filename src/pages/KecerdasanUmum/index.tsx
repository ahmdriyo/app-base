...
import quizDataKecerdasanUmum from "../../../assets/data/quizDataKecerdasanUmum.json";
...
const KecerdasanUmum: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataKecerdasanUmum).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Kecerdasan{'\n'}    Umum</Text>
              </View>
            </View>
            {currentQuestion && (
