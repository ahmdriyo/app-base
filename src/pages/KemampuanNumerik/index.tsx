...
import quizDataKemampuanNumerik from "../../../assets/data/quizDataKemampuanNumerik.json";
...
const KemampuanNumerik: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataKemampuanNumerik).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Kemampuan {'\n'}    Numerik</Text>
              </View>
            </View>
            {currentQuestion && (
...
export default KemampuanNumerik;
