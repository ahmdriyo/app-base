...
import quizDataKemampuanVerbal from "../../../assets/data/quizDataKemampuanVerbal.json";
...
const KemampuanVerbal: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataKemampuanVerbal).slice(0,20);
...
export default KemampuanVerbal;
