...
import quizDataEkst from "../../../assets/data/quizDataEkst.json";
...
const Ekstrovert: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataEkst).slice(0,20);
      ...
      {showScore ? (
        <View style={styles.containerScore}>
          ...
          >
            ...
            >
              <Text style={styles.textTes}>Tes Ekstrovert</Text>
              <Text style={styles.texts}>Jika nilai ada lebih dari 70 maka kepribadian anda cenderung</Text>
              <Text style={styles.textEkstrovert}>"Ekstrovert"</Text>
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            ...
            >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Kepribadian</Text>
              </View>
            </View>
            {currentQuestion && (
