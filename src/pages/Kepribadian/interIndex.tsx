...
import quizDataIntr from "../../../assets/data/quizDataIntr.json";
...
const Introvert: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataIntr).slice(0,20);
      ...
      {showScore ? (
        <View style={styles.containerScore}>
          ...
          >
            ...
            >
              <Text style={styles.textTes}>Tes Introvert</Text>
              <Text style={styles.texts}>Jika nilai ada lebih dari 70 maka kepribadian anda cenderung</Text>
              <Text style={styles.textEkstrovert}>"Introvert"</Text>
