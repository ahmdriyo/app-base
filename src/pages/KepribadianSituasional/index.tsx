...
import quizDataKepribadianSituasional from "../../../assets/data/quizDataSituasional.json";
...
const KepribadianSituasional: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataKepribadianSituasional).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Kepribadian{'\n'} Situasional</Text>
              </View>
            </View>
            {currentQuestion && (
...
export default KepribadianSituasional;
