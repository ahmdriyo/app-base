...
import quizDataKeterampilanKerja from "../../../assets/data/quizDataKeterampilanKerja.json";
...
const KeterampilanKerja: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataKeterampilanKerja).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Keterampilan {'\n'}       Kerja</Text>
              </View>
            </View>
            {currentQuestion && (
...
export default KeterampilanKerja;
