...
import quizDataProyektif from "../../../assets/data/quizDataProyektif.json";
...
const Proyektif: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataProyektif).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Proyektif</Text>
              </View>
            </View>
            {currentQuestion && (
