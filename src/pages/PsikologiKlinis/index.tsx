...
import quizDataPsikologiKlinis from "../../../assets/data/quizDataKlinis.json";
...
const PsikologiKlinis: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataPsikologiKlinis).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Psikologi {'\n'}   Klinis</Text>
              </View>
            </View>
            {currentQuestion && (
...
export default PsikologiKlinis;
