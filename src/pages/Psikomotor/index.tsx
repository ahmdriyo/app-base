...
import quizDataPsikomotor from "../../../assets/data/quizDataPsikomotor.json";
...
const Psikomotor: React.FC<Props> = ({ navigation }) => {
  ...
  const resetQuiz = () => {
    let shuffledQuestions: QuizData[] = shuffleArray(quizDataPsikomotor).slice(0,20);
        ...
        <View style={styles.questionContainer}>
          <ImageBackground source={bgQuiz} style={{ flex: 1 }}>
            <View style={styles.questionContent} >
              ...
              <View>
                <Text style={{ fontWeight: "bold" }}>Psikomotor</Text>
              </View>
            </View>
            {currentQuestion && (
